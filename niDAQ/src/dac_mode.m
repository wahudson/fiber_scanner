%% 2023-12-14  William A. Hudson
%#! Matlab
%
% niDAQ Analog Input mode.  Derived from dc_voltmeter.m
...
%% DAQ Mode
    ...
    fprintf( 'DAQ mode:  chInSig\n' );
    get( chInSig );
    fprintf( 'DAQ mode:  chInSum\n' );
    get( chInSum );
    fprintf( 'DAQ mode:  chInX\n' );
    get( chInX );
    fprintf( 'DAQ mode:  chInY\n' );
    get( chInY );

    % view allowed range of channel properties 
    fprintf( 'DAQ allowed properties:\n' );
    set( chInSig );

    % chInSig.TerminalConfig = "Differential";
    % chInSig.TerminalConfig = "SingleEnded";
